    ...
    if fuori_range:
        if not allarme_gia_inviato:
            ...
            testo = (
                ...
                f"AERO Maturati stima: +{aero_earned:.2f} $\n"
        ...
        if not pre_allarme_gia_inviato:
            testo = (
                f"⚠️ <b>PRE-ALLARME PROSSIMITÀ</b> ⚠️\n\n"
                f"Il prezzo di {live_price:.2f} $ è arrivato al <b>{dist_minima:.1f}%</b> dal limite del range.\n"
                f"Range impostato: {p_a:.2f} - {p_b:.2f}\n\n"
